...
def documentation_agent(refined_requirements, temperature):
    ...
    template = """As a documentation specialist, compile a functional requirements document (FRD) based on these refined requirements:
        ...
        2. Provide a comprehensive table of contents with page numbers in a proper readable fromat.
        ...
        7. Include a section on future considerations or potential enhancements for future phases or versions.
